...
namespace Actores
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            p1.SetTitulo("Shrek");
            p1.SetAño(2018);
            p1.SetDirector("Andrew Adamson");
            p1.SetPais("Estados Unidos");
            p1.AgregarActor(new Actor("Mike Myers", 1963));
            p1.AgregarActor(new Actor("Eddie Murphy", 1961));
            Console.WriteLine("{0}, {1}, {2}, {3}\n", p1.GetTitulo(), p1.GetAño(), p1.GetDirector(), p1.GetPais());
            p1.ImprimeActor();

            Console.WriteLine("");

            p2.SetTitulo("Castillo Ambulante");
            p2.SetAño(2009);
            p2.SetDirector("Hayao Miyazaki");
            p2.SetPais("Japon");
            p2.AgregarActor(new Actor("Christian Bale", 1974));
            p2.AgregarActor(new Actor("Emily Mortimer", 1971));
